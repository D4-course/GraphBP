"""
Code to split sdf file for GraphBP
"""
...
if __name__ == '__main__':
    ...
    for i, line in enumerate(lines):
        pct = 100 * (i + 1) / n_lines
        print(f'[{pct:.2f}%] ', end='')
        sdf_file = os.path.join(data_root, line.split()[4].rsplit(
            '.', 1)[0])  # Use .sdf file instead of .sdf.gz file
