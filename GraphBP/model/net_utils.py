...
class Rescale(nn.Module):
    """
    Neural Network Class to Rescale
    """
    def __init__(self):
    ...
    def forward(self, x):
        """
        Function for forward propagation of rescale
        """
...
def init_layer(layer: torch.nn.Linear, w_scale=1.0) -> torch.nn.Linear:
    """
    Function to initialise a neural network layer
    """
...
class MLP(nn.Module):
    ...
    def forward(self, x):
        """
        Function for forward propagation of MLP
        """
...
class LB2(nn.Module):
    ...
    def forward(self, x):
        """
        Function for forward propagation of LB2
        """
